  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        className="p-6 sm:p-8 border-2 border-[#1a1a1c] dark:border-[#f0f6fc] bg-[#fdf6e2] dark:bg-[#b08800]/15 text-[#1a1a1c] dark:text-[#f0f6fc] shadow-xs"
      >
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div>
            <span className="label-mono text-[#b08800] dark:text-[#e3b341]">
              Threshold Alert
            </span>
            <h2 className="font-syne text-xl sm:text-2xl font-extrabold uppercase tracking-tight mt-1.5 text-[#1a1a1c] dark:text-[#f0f6fc]">
              {isExceeded ? 'Transition Threshold Exceeded' : 'Hobby Milestone Tracking'}
            </h2>
            <p className="font-mono-code text-xs sm:text-sm mt-1 text-[#1a1a1c]/80 dark:text-[#f0f6fc]/80 font-semibold">
              {owner}/{repo} {npmPackageName && <span className="opacity-70">(npm: {npmPackageName})</span>}
            </p>
          </div>
        ...
        <p className="text-xs sm:text-sm mt-4 sm:mt-5 leading-relaxed text-[#1a1a1c]/80 dark:text-[#f0f6fc]/80 max-w-3xl">
